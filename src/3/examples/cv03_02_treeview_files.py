...
class myApp:
  def __init__(self, window):
    ...
    self.tree = ttk.Treeview(window, columns=('filename', 'size', 'date_modified'), show='tree headings')
    ...
    self.tree.insert(movies, END, values=('par_parmenu_4K.mkv', '80 GB', '2024/03/07'))
    for _ in range(20):
